...
public abstract class RegularControlSubsystem<ControlStates extends Enum<ControlStates>> extends SubsystemBase {
    ...
    public RegularControlSubsystem(PIDController pidController) {
