...
import frc.robot.Constants.ModuleConfiguration;
import frc.robot.Constants.RobotConfiguration;
import frc.robot.RobotContainer;

public class AutonUtils {
    /** Robot Constraints for Pathfinding. */
    public static final PathConstraints CONSTRAINTS = new PathConstraints(RobotConfiguration.MAX_DRIVE_VELOCITY, RobotConfiguration.MAX_DRIVE_ACCELERATION, RobotConfiguration.MAX_ANGULAR_VELOCITY, RobotConfiguration.MAX_ANGULAR_ACCELERATION);

    /** Robot Configuration for generating trajectories. */
    public static RobotConfig robotConfig;

    static {
        ModuleConfig moduleConfig = new ModuleConfig(ModuleConfiguration.WHEEL_RADIUS, RobotConfiguration.MAX_DRIVE_VELOCITY, ModuleConfiguration.WHEEL_COF, DCMotor.getKrakenX60(1), 60.0, 1);
        ...
        try {
            ...
            e.printStackTrace();
            robotConfig = new RobotConfig(Constants.ROBOT_MASS, ModuleConfiguration.MOI, moduleConfig, ModuleConfiguration.TRACK_WIDTH);
        }
    }
